...
<section class="bg-brandDarkBlue pt-16 pb-0">
...
<section class="bg-[#f9f9f9] pt-32 pb-32">
		...
		<div class="grid grid-cols-3 gap-12">
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					<i class="fa-regular fa-house-heart text-5xl text-brandOrange"></i>
				</div>
			...
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					<i class="fa-regular fa-briefcase-blank text-5xl text-brandOrange"></i>
				</div>
				<h3 class="font-oregon font-medium text-black text-3xl text-center mb-3">
					Business Services
				</h3>
			...
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					<i class="fa-regular fa-family text-5xl text-brandOrange"></i>
				</div>
			...
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					<i class="fa-regular fa-sign-hanging text-5xl text-brandOrange" />
				</div>
			...
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					<i class="fa-light fa-chair-office text-5xl text-brandOrange" />
				</div>
				<h3 class="font-oregon font-medium text-black text-3xl text-center mb-3">
			...
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					...
					<i class="fa-light fa-file-contract text-5xl text-brandOrange" />
				</div>
				<h3 class="font-oregon font-medium text-black text-3xl text-center mb-3">
...
<section class="bg-white pt-32 pb-32">
	<div class="w-full max-w-screen-xl mx-auto">
		<div class="grid grid-cols-2 gap-12">
			<div>
				<div class="flex justify-center items-center mb-5">
					<img src="/connie_about.jpg" alt="Connie Chadwick" class="w-full" />
				</div>
			</div>
			<div>
				<h3 class="font-oregon font-medium text-black text-5xl mb-3">About Connie</h3>
				<p class="font-montserrat font-normal text-black text-lg mb-4">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet consequatur quia
					aspernatur eaque optio officiis. Lorem ipsum dolor sit amet consectetur adipisicing elit.
					Eveniet consequatur quia aspernatur eaque optio officiis. Lorem ipsum dolor sit amet
					consectetur adipisicing elit. Eveniet consequatur quia aspernatur eaque optio officiis.
				</p>
				<p class="font-montserrat font-normal text-black text-lg mb-4">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet consequatur quia
					aspernatur eaque optio officiis. Lorem ipsum dolor sit amet consectetur adipisicing elit.
...
<section class="bg-brandDarkBlue pt-28 pb-28">
	<div class="w-full max-w-screen-xl mx-auto">
		<h2 class="font-oregon font-medium text-white text-5xl mb-12 text-center">
		...
		>
			<SplideSlide>
				<div class="testimonial">
					<p class="font-montserrat font-normal text-white text-lg mb-4 text-center">
					...
					<p class="font-montserrat font-normal text-white text-lg mb-4 text-center">- Mike</p>
				</div>
			</SplideSlide>
			<SplideSlide>
				<div class="testimonial">
					...
					<p class="font-montserrat font-normal text-white text-lg mb-4 text-center">- Dawn</p>
				</div>
			</SplideSlide>
			<SplideSlide>
				<div class="testimonial">
					...
					<p class="font-montserrat font-normal text-white text-lg mb-4 text-center">- Andrew</p>
				</div>
			</SplideSlide>
			<SplideSlide>
				<div class="testimonial">
					...
					<p class="font-montserrat font-normal text-white text-lg mb-4 text-center">- Aaron</p>
				</div>
			</SplideSlide>
		</Splide>
	</div>
