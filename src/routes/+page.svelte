...
<section class="bg-[#f9f9f9] pt-44 lg:pt-32 pb-12 lg:pb-32">
	<div class="container_xl container_padding">
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
			...
			<div class="bg-white p-12 rounded-xl shadow-xl">
				<div class="flex justify-center items-center mb-5">
					<i class="fa-regular fa-briefcase-blank text-5xl text-brandOrange" />
				</div>
				<h3 class="font-oregon font-medium text-black text-3xl text-center mb-3">
					Business Services
				</h3>
				...
				<div class="grid grid-cols-4 gap-5">
					<div>
						<a
							...
							rel="me"
							target="_blank"
							href="https://www.avvo.com/attorneys/37174-tn-connie-chadwick-4637366.html"
							><svg
								class="avvo-badge"
								id="js-avvo-badge-client-choice-2015"
								style="enable-background:new 0 0 273.75 199.375; height: auto; width: 100%;"
								version="1.1"
								...
								><style type="text/css">
									...
									><g
										...
										></g
									><g
										><rect class="st3" height="191" width="169" x="52.448" y="4.201" /><path
											class="st2"
											d="M217.448,8.201v183h-161v-183H217.448 M225.448,0.201h-8h-161h-8v8v183v8h8h161h8v-8v-183V0.201 L225.448,0.201z"
										/></g
									><rect class="st2" height="34.841" width="210.276" x="31.81" y="109.594" /><text
										class="st3 st10 st12"
										x="50%"
										y="133"
										style="font-size: 14px !important;">Connie Chadwick</text
									><g
										><g
											><g
												><path
									...
									><text transform="matrix(1 0 0 1 65.8555 66.2344)"
										><tspan class="st6 st7 st8 st9 st12" x="71" y="0">Clients’ Choice</tspan><tspan
											class="st6 st7 st8 st9 st12 js-avvo-badge-year"
											x="71"
											y="28">Award 2015</tspan
										></text
									></g
								></svg
							></a
					...
					<div>
						<a
							...
							><svg
								...
								style="enable-background:new 0 0 280 220; height: auto; width: 100%;"
								version="1.1"
								viewbox="0 0 280 220"
								x="0px"
								xml:space="preserve"
								...
								><style type="text/css">
									...
									><g
										...
										/><g
											...
											/></g
										></g
									><rect class="st2" height="34.841" width="210.276" x="32.494" y="110.567" /><g
										><path
											class="st2"
										...
										/></g
									><rect class="st4" height="47.524" width="141" x="66.567" y="49.875" /><text
										class="st6 st7 st11 st12"
										id="js-avvo-rating-4637366"
										transform="matrix(1 0 0 1 72.0684 96.9355)"
										x="66.567">10.0</text
									><text class="st3 st10 st12" x="50%" y="134" style="font-size: 14px !important;"
										>Connie Chadwick</text
									></g
								></svg
							></a
						><script>
							(function (context) {
								...
								function alertContents(httpRequest) {
									if (httpRequest.readyState == 4) {
										if (httpRequest.status == 200 || httpRequest.status == 0) {
											...
											document.getElementById('js-avvo-rating-4637366').textContent =
												payload.avvo_rating;
										}
									}
								}
								...
								send_with_ajax(
									'https://www.avvo.com/attorney-badges/v3/lawyers/avvo-rating/4637366'
								);
							})(window);
						</script>
					</div>
